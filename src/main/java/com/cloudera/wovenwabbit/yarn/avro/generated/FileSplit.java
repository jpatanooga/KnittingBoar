...
public class FileSplit extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"FileSplit\",\"namespace\":\"com.cloudera.wovenwabbit.yarn.avro.generated\",\"fields\":[{\"name\":\"path\",\"type\":\"string\"},{\"name\":\"offset\",\"type\":\"long\"},{\"name\":\"length\",\"type\":\"long\"}]}");
  ...
  public static com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder newBuilder() {
    return new com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder();
  }
  
  /** Creates a new FileSplit RecordBuilder by copying an existing Builder */
  public static com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder newBuilder(com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder other) {
    return new com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder(other);
  }
  
  /** Creates a new FileSplit RecordBuilder by copying an existing FileSplit instance */
  public static com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder newBuilder(com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit other) {
    return new com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<FileSplit>
    ...
    private Builder() {
      super(com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder other) {
      super(other);
    }
    
    /** Creates a Builder by copying an existing FileSplit instance */
    private Builder(com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit other) {
            super(com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.SCHEMA$);
    ...
    /** Sets the value of the 'path' field */
    public com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder setPath(java.lang.CharSequence value) {
    ...
    public com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder clearPath() {
      path = null;
    ...
    /** Sets the value of the 'offset' field */
    public com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder setOffset(long value) {
    ...
    public com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder clearOffset() {
    ...
    /** Sets the value of the 'length' field */
    public com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder setLength(long value) {
    ...
    public com.cloudera.wovenwabbit.yarn.avro.generated.FileSplit.Builder clearLength() {
